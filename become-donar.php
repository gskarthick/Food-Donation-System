...
$age=$_POST['age'];
$gender=$_POST['gender'];
$blodgroup=$_POST['Food Type'];
$address=$_POST['address'];
$message=$_POST['message'];
$status=1;
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,Food Type,Address,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:address,:message,:status)";
...
<head>
    ...
    <title>Food Donation System | Become A Donar</title>
...
<div><select name="Food Type" class="form-control" required>
